...
\begin{document}
	...
	\author{\IEEEauthorblockN{1\textsuperscript{st} Sampath Kumar } \IEEEauthorblockA{\textit{Department of Computer Science Engineering} \\ \textit{SRM Institute of Science and Technology}\\ Chennai, India \\ sz4961@srmist.edu.in}
	\and \IEEEauthorblockN{2\textsuperscript{nd} Dr.Krishnaraj N} \IEEEauthorblockA{\textit{Department of Networking And Communications} \\ \textit{SRM Institute of Science and Technology}\\ Chennai, India \\ krishnan2@srmist.edu.in}
	}
	...
	\begin{table}[H]
		...
		% Use \linewidth or \columnwidth in a two-column style
...
%--- Baseline Gantt Charts (Q-learning Before, SARSA Before, Greedy) ---
\begin{figure*}[htbp]
	\centering
...
%--- Refined Gantt Charts (Refined Q-learning, Refined SARSA) ---
\begin{figure*}[htbp]
	\centering
...
%--- Workload Balance Ratio (Bar Chart) ---
\begin{figure}[htbp]
	\centering
...
%--- Rewards During Training (Line Chart) ---
\begin{figure}[htbp]
	\centering
...
%--- ACO Task Sequence (Graph Diagram) ---
\begin{figure}[htbp]
	\centering
